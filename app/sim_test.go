...
func TestAppImportExport(t *testing.T) {
	...
	app := NewStrideApp(logger, db, nil, true, map[int64]bool{}, dir, 5, encConf, simapp.EmptyAppOptions{}, fauxMerkleModeOpt)
...
func TestFullAppSimulation(t *testing.T) {
	...
	encConf := MakeEncodingConfig()
	app := NewStrideApp(logger, db, nil, true, map[int64]bool{}, t.TempDir(), 5, encConf, simapp.EmptyAppOptions{}, fauxMerkleModeOpt)
	require.Equal(t, Name, app.Name())
