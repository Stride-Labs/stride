...
var (
	...
	maccPerms = map[string][]string{
		...
		stakeibcmoduletypes.ReinvestmentCollectorName: nil,
...
func (app *StrideApp) BlacklistedModuleAccountAddrs() map[string]bool {
	...
	for _, acc := range utils.StringMapKeys(maccPerms) {
		...
		if acc == stakeibcmoduletypes.ModuleName || acc == stakeibcmoduletypes.RewardCollectorName || acc == stakeibcmoduletypes.ReinvestmentCollectorName {
			continue
		}
		modAccAddrs[authtypes.NewModuleAddress(acc).String()] = true
	}
