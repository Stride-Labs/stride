...
func NewStrideApp(
	...
	govRouter.AddRoute(govtypes.RouterKey, govtypes.ProposalHandler).
		...
		AddRoute(stakeibcmoduletypes.RouterKeyAddValidator, stakeibcmodule.NewAddValidatorProposalHandler(app.StakeibcKeeper)).
		AddRoute(stakeibcmoduletypes.RouterKeyDeleteValidator, stakeibcmodule.NewDeleteValidatorProposalHandler(app.StakeibcKeeper))
