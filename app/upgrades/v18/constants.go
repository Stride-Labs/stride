...
var (
	...
	RedemptionRatesAtTimeOfProp = map[string]sdk.Dec{
		"comdex-1":     sdk.MustNewDecFromStr("1.204789775596912578"),
		"cosmoshub-4":  sdk.MustNewDecFromStr("1.299673104777517344"),
		"evmos_9001-2": sdk.MustNewDecFromStr("1.492732455077015014"),
		"injective-1":  sdk.MustNewDecFromStr("1.215905443857494066"),
		"juno-1":       sdk.MustNewDecFromStr("1.418570871812957888"),
		"osmosis-1":    sdk.MustNewDecFromStr("1.201661807376110166"),
		"phoenix-1":    sdk.MustNewDecFromStr("1.178481903955981465"),
		"sommelier-3":  sdk.MustNewDecFromStr("1.025900894556370846"),
		"stargaze-1":   sdk.MustNewDecFromStr("1.430361044605293188"),
		"umee-1":       sdk.MustNewDecFromStr("1.128788161214225703"),
	}

	// Get Amount Unbonded for each HostZone for Unbonding Records Migration
	StartingEstimateEpoch     = uint64(510)
