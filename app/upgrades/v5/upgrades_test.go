...
import (
	...
	"github.com/Stride-Labs/stride/v25/app"

	"github.com/Stride-Labs/stride/v25/app/apptesting"
	upgradev5 "github.com/Stride-Labs/stride/v25/app/upgrades/v5"
	...
	recordkeeper "github.com/Stride-Labs/stride/v25/x/records/keeper"
	oldrecordtypes "github.com/Stride-Labs/stride/v25/x/records/migrations/v2/types"
	...
	oldstakeibctypes "github.com/Stride-Labs/stride/v25/x/stakeibc/migrations/v2/types"
	newstakeibctypes "github.com/Stride-Labs/stride/v25/x/stakeibc/migrations/v3/types"
