...
def main() -> int:
    ...
    current_vals = load_csv_by_chain(CURRENT_WEIGHTS_PATH)
    print(f"Found {sum(len(v) for v in current_vals.values())} current validators across {len(current_vals)} chains")
