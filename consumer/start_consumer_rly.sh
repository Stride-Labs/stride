...
# $SOVEREIGN_BINARY tx gov submit-legacy-proposal software-upgrade "v10" --upgrade-height=36  \
...
$SOVEREIGN_BINARY tx gov submit-legacy-proposal software-upgrade "v10" \
--upgrade-height=36 \
