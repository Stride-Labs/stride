...
var (
	...
	ErrMarshalFailure            = errorsmod.Register(ModuleName, 12, "unable to marshal data structure")
	ErrUnmarshalFailure          = errorsmod.Register(ModuleName, 13, "unable to unmarshal data structure")
	ErrInvalidCallback           = errorsmod.Register(ModuleName, 14, "invalid callback data")
	ErrICAAccountDoesNotExist    = errorsmod.Register(ModuleName, 15, "ICA account does not exist")
	ErrInvalidGenesisState       = errorsmod.Register(ModuleName, 16, "Invalid genesis state")
)
