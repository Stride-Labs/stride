...
var (
	...
	ErrInvalidCallback           = errorsmod.Register(ModuleName, 11, "invalid callback data")
	ErrICAAccountDoesNotExist    = errorsmod.Register(ModuleName, 12, "ICA account does not exist")
	ErrInvalidGenesisState       = errorsmod.Register(ModuleName, 13, "Invalid genesis state")
)
