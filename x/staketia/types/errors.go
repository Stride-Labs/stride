...
var (
	...
	ErrRedemptionRateOutsideSafetyBounds = errorsmod.Register(ModuleName, 1908, "redemption rate outside safety bounds")
	ErrInvalidRedemptionRateBounds       = errorsmod.Register(ModuleName, 1909, "invalid redemption rate bounds")
)
