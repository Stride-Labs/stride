...
type EpochInfo struct {
	...
	CurrentEpoch            github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,4,opt,name=current_epoch,json=currentEpoch,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"current_epoch"`
	...
	CurrentEpochStartHeight github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,7,opt,name=current_epoch_start_height,json=currentEpochStartHeight,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"current_epoch_start_height"`
}
...
var fileDescriptor_92af8154b2eb736d = []byte{
	...
	,
}
...
func (m *EpochInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.CurrentEpochStartHeight.Size()
		i -= size
		if _, err := m.CurrentEpochStartHeight.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
	...
	dAtA[i] = 0x2a
	{
		size := m.CurrentEpoch.Size()
		i -= size
		if _, err := m.CurrentEpoch.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintGenesis(dAtA, i, uint64(size))
	}
...
func (m *EpochInfo) Size() (n int) {
	...
	l = m.CurrentEpochStartHeight.Size()
	n += 1 + l + sovGenesis(uint64(l))
	return n
}
...
func (m *EpochInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if err := m.CurrentEpochStartHeight.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
