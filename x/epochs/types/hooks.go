...
type EpochHooks interface {
	...
	AfterEpochEnd(ctx context.Context, epochInfo EpochInfo)
	// new epoch is next block of epoch end block
	BeforeEpochStart(ctx context.Context, epochInfo EpochInfo)
}
...
func (h MultiEpochHooks) AfterEpochEnd(ctx context.Context, epochInfo EpochInfo) {
	for i := range h {
...
func (h MultiEpochHooks) BeforeEpochStart(ctx context.Context, epochInfo EpochInfo) {
	for i := range h {
