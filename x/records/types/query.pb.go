...
type QueryAllUserRedemptionRecordForUserRequest struct {
	...
	Day        github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,2,opt,name=day,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"day"`
	Address    string                                 `protobuf:"bytes,3,opt,name=address,proto3" json:"address,omitempty"`
	Limit      github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,4,opt,name=limit,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"limit"`
...
type QueryGetEpochUnbondingRecordRequest struct {
	EpochNumber github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,1,opt,name=epoch_number,json=epochNumber,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"epoch_number"`
}
...
var fileDescriptor_25e7cc311be81f7b = []byte{
	...
	,
}
...
func (m *QueryAllUserRedemptionRecordForUserRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	}
	{
		size := m.Day.Size()
		i -= size
		if _, err := m.Day.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintQuery(dAtA, i, uint64(size))
	}
