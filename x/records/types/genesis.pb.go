...
const (
	...
	DepositRecord_STATUS_TRANSFER DepositRecord_Status = 0
	// pending staking on delegate account
	DepositRecord_STATUS_STAKE DepositRecord_Status = 1
)
...
const (
	DepositRecord_SOURCE_STRIDE         DepositRecord_Source = 0
	DepositRecord_SOURCE_WITHDRAWAL_ICA DepositRecord_Source = 1
)

var DepositRecord_Source_name = map[int32]string{
	0: "SOURCE_STRIDE",
	1: "SOURCE_WITHDRAWAL_ICA",
}

var DepositRecord_Source_value = map[string]int32{
	"SOURCE_STRIDE":         0,
	"SOURCE_WITHDRAWAL_ICA": 1,
}
...
const (
	...
	HostZoneUnbonding_STATUS_BONDED HostZoneUnbonding_Status = 0
	// unbonding completed on delegate account
	HostZoneUnbonding_STATUS_UNBONDED HostZoneUnbonding_Status = 1
	// transfer success
	HostZoneUnbonding_STATUS_TRANSFERRED HostZoneUnbonding_Status = 2
)
...
func (m *DepositRecord) GetStatus() DepositRecord_Status {
	...
	return DepositRecord_STATUS_TRANSFER
}
...
func (m *DepositRecord) GetSource() DepositRecord_Source {
	...
	return DepositRecord_SOURCE_STRIDE
}
...
func (m *HostZoneUnbonding) GetStatus() HostZoneUnbonding_Status {
	...
	return HostZoneUnbonding_STATUS_BONDED
}
...
var fileDescriptor_98cfd0253c8b6797 = []byte{
	...
	,
}
