...
type UserRedemptionRecord struct {
	...
	EpochNumber int64  `protobuf:"varint,7,opt,name=epochNumber,proto3" json:"epochNumber,omitempty"`
...
func (m *UserRedemptionRecord) GetEpochNumber() int64 {
	if m != nil {
...
type HostZoneUnbonding struct {
	...
	Status         HostZoneUnbonding_Status `protobuf:"varint,4,opt,name=status,proto3,enum=Stridelabs.stride.records.HostZoneUnbonding_Status" json:"status,omitempty"`
	CompletionTime time.Time                `protobuf:"bytes,5,opt,name=completionTime,proto3,stdtime" json:"completionTime" yaml:"unbonding_time"`
	// Index UserRedemptionRecords here (note: id is {chain_id}.{epoch}.{sender})
	UserRedemptionRecords []string `protobuf:"bytes,6,rep,name=userRedemptionRecords,proto3" json:"userRedemptionRecords,omitempty"`
}
...
func (m *HostZoneUnbonding) GetAmount() uint64 {
	if m != nil {
		return m.Amount
	}
	return 0
...
func (m *HostZoneUnbonding) GetCompletionTime() time.Time {
	if m != nil {
...
type EpochUnbondingRecord struct {
	Id                   uint64                        `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	UnbondingEpochNumber uint64                        `protobuf:"varint,2,opt,name=unbondingEpochNumber,proto3" json:"unbondingEpochNumber,omitempty"`
...
func (m *EpochUnbondingRecord) GetUnbondingEpochNumber() uint64 {
	if m != nil {
		return m.UnbondingEpochNumber
	}
	return 0
}
...
var fileDescriptor_03dd178cbf8084c6 = []byte{
	...
	,
}
...
func (m *EpochUnbondingRecord) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.UnbondingEpochNumber != 0 {
		i = encodeVarintGenesis(dAtA, i, uint64(m.UnbondingEpochNumber))
		i--
		dAtA[i] = 0x10
	}
	if m.Id != 0 {
...
func (m *EpochUnbondingRecord) Size() (n int) {
	...
	if m.UnbondingEpochNumber != 0 {
		n += 1 + sovGenesis(uint64(m.UnbondingEpochNumber))
	}
	if len(m.HostZoneUnbondings) > 0 {
...
func (m *EpochUnbondingRecord) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UnbondingEpochNumber", wireType)
			}
			m.UnbondingEpochNumber = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowGenesis
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.UnbondingEpochNumber |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
