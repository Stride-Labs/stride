...
type TransferLSMTokenCallback struct {
	...
	HostZoneDepositAddress       string           `protobuf:"bytes,3,opt,name=host_zone_deposit_address,json=hostZoneDepositAddress,proto3" json:"host_zone_deposit_address,omitempty"`
	HostZoneDelegationIcaAddress string           `protobuf:"bytes,4,opt,name=host_zone_delegation_ica_address,json=hostZoneDelegationIcaAddress,proto3" json:"host_zone_delegation_ica_address,omitempty"`
}
...
func (m *TransferLSMTokenCallback) GetTransferChannelId() string {
	if m != nil {
...
func (m *TransferLSMTokenCallback) GetHostZoneDepositAddress() string {
	if m != nil {
		return m.HostZoneDepositAddress
	}
	return ""
}

func (m *TransferLSMTokenCallback) GetHostZoneDelegationIcaAddress() string {
	if m != nil {
		return m.HostZoneDelegationIcaAddress
	}
	return ""
}
...
var fileDescriptor_6f7cdd5c1d8b3a46 = []byte{
	...
	,
}
...
func (m *TransferLSMTokenCallback) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.HostZoneDelegationIcaAddress) > 0 {
		i -= len(m.HostZoneDelegationIcaAddress)
		copy(dAtA[i:], m.HostZoneDelegationIcaAddress)
		i = encodeVarintCallbacks(dAtA, i, uint64(len(m.HostZoneDelegationIcaAddress)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.HostZoneDepositAddress) > 0 {
		i -= len(m.HostZoneDepositAddress)
		copy(dAtA[i:], m.HostZoneDepositAddress)
		i = encodeVarintCallbacks(dAtA, i, uint64(len(m.HostZoneDepositAddress)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.TransferChannelId) > 0 {
		...
		i = encodeVarintCallbacks(dAtA, i, uint64(len(m.TransferChannelId)))
		i--
		dAtA[i] = 0x12
	}
	if m.Deposit != nil {
...
func (m *TransferLSMTokenCallback) Size() (n int) {
	...
	l = len(m.HostZoneDepositAddress)
	if l > 0 {
		n += 1 + l + sovCallbacks(uint64(l))
	}
	l = len(m.HostZoneDelegationIcaAddress)
	if l > 0 {
		n += 1 + l + sovCallbacks(uint64(l))
	}
	return n
...
func (m *TransferLSMTokenCallback) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HostZoneDepositAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HostZoneDepositAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HostZoneDelegationIcaAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HostZoneDelegationIcaAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipCallbacks(dAtA[iNdEx:])
