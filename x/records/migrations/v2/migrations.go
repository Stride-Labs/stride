...
func migrateDepositRecord(store sdk.KVStore, cdc codec.BinaryCodec) error {
	...
	for ; iterator.Valid(); iterator.Next() {
		...
		if err != nil {
			return fmt.Errorf("unable to unmarshal deposit record (%v) using old data type: %s", iterator.Key(), err.Error())
		}
		...
		if err != nil {
			return fmt.Errorf("unable to marshal deposit record (%v) using new data type: %s", iterator.Key(), err.Error())
		}
...
func migrateUserRedemptionRecord(store sdk.KVStore, cdc codec.BinaryCodec) error {
	...
	for ; iterator.Valid(); iterator.Next() {
		...
		if err != nil {
			return fmt.Errorf("unable to unmarshal redemption record (%v) using old data type: %s", iterator.Key(), err.Error())
		}
		...
		if err != nil {
			return fmt.Errorf("unable to marshal redemption record (%v) using new data type: %s", iterator.Key(), err.Error())
		}
...
func migrateEpochUnbondingRecord(store sdk.KVStore, cdc codec.BinaryCodec) error {
	...
	for ; iterator.Valid(); iterator.Next() {
		...
		if err != nil {
			return fmt.Errorf("unable to unmarshal epoch unbonding record (%v) using old data type: %s", iterator.Key(), err.Error())
		}
		...
		if err != nil {
			return fmt.Errorf("unable to marshal epoch unbonding record (%v) using new data type: %s", iterator.Key(), err.Error())
		}
