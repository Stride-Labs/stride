...
type TokenPriceResponse struct {
	...
	// Pool ID on Osmosis
	OsmosisPoolId uint64 `protobuf:"varint,9,opt,name=osmosis_pool_id,json=osmosisPoolId,proto3" json:"osmosis_pool_id,omitempty"`
	// Osmosis pool type (gamm or CL)
	OsmosisPoolType OsmosisPoolType `protobuf:"varint,10,opt,name=osmosis_pool_type,json=osmosisPoolType,proto3,enum=stride.icqoracle.OsmosisPoolType" json:"osmosis_pool_type,omitempty"`
	// Spot price of base_denom denominated in quote_denom
	SpotPrice cosmossdk_io_math.LegacyDec `protobuf:"bytes,11,opt,name=spot_price,json=spotPrice,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"spot_price"`
	// Last time a query request was submitted
	LastRequestTime time.Time `protobuf:"bytes,12,opt,name=last_request_time,json=lastRequestTime,proto3,stdtime" json:"last_request_time"`
	// Last time a query response was received
	LastResponseTime time.Time `protobuf:"bytes,13,opt,name=last_response_time,json=lastResponseTime,proto3,stdtime" json:"last_response_time"`
	// Whether there is a spot price query currently in progress
	QueryInProgress bool `protobuf:"varint,14,opt,name=query_in_progress,json=queryInProgress,proto3" json:"query_in_progress,omitempty"`
}
...
func (m *TokenPriceResponse) GetOsmosisPoolId() uint64 {
	if m != nil {
...
func (m *TokenPriceResponse) GetOsmosisPoolType() OsmosisPoolType {
	if m != nil {
...
var fileDescriptor_51a2bacbcf1e1cb4 = []byte{
	...
	,
}
...
func (m *TokenPriceResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.OsmosisPoolType != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.OsmosisPoolType))
		i--
		dAtA[i] = 0x50
	}
	if m.OsmosisPoolId != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.OsmosisPoolId))
		i--
		dAtA[i] = 0x48
	}
...
func (m *TokenPriceResponse) Size() (n int) {
	...
	if m.OsmosisPoolId != 0 {
		n += 1 + sovQuery(uint64(m.OsmosisPoolId))
	}
	if m.OsmosisPoolType != 0 {
		n += 1 + sovQuery(uint64(m.OsmosisPoolType))
	}
	l = m.SpotPrice.Size()
	n += 1 + l + sovQuery(uint64(l))
