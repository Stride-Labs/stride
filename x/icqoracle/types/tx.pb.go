...
type MsgRegisterTokenPriceQuery struct {
	...
	// Pool ID on Osmosis
	OsmosisPoolId uint64 `protobuf:"varint,8,opt,name=osmosis_pool_id,json=osmosisPoolId,proto3" json:"osmosis_pool_id,omitempty"`
	// Pool type on Osmosis (GAMM or CL)
	OsmosisPoolType OsmosisPoolType `protobuf:"varint,9,opt,name=osmosis_pool_type,json=osmosisPoolType,proto3,enum=stride.icqoracle.OsmosisPoolType" json:"osmosis_pool_type,omitempty"`
}
...
func (m *MsgRegisterTokenPriceQuery) GetOsmosisPoolType() OsmosisPoolType {
	if m != nil {
...
var fileDescriptor_be640eb75c1babd5 = []byte{
	...
	,
}
...
func (m *MsgRegisterTokenPriceQuery) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.OsmosisPoolType != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.OsmosisPoolType))
		i--
		dAtA[i] = 0x48
	}
...
func (m *MsgRegisterTokenPriceQuery) Size() (n int) {
	...
	if m.OsmosisPoolType != 0 {
		n += 1 + sovTx(uint64(m.OsmosisPoolType))
	}
	return n
}
