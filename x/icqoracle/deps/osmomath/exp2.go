// Forked from https://github.com/osmosis-labs/osmosis/blob/v27.0.0/osmomath/exp2.go under the Apache v2.0 License
package osmomath
...
var (
	...
	numeratorCoefficients13Param = []BigDec{
		...
		MustNewBigDecFromStr("0.056507868883666405413116800969512484"),
		MustNewBigDecFromStr("0.005343900728213034434757419480319916"),
		MustNewBigDecFromStr("0.000317708814342353603087543715930732"),
		MustNewBigDecFromStr("0.000011429747507407623028722262874632"),
		MustNewBigDecFromStr("0.000000198381965651614980168744540366"),
	}
	...
	denominatorCoefficients13Param = []BigDec{
		OneBigDec(),
		MustNewBigDecFromStr("0.341114724742545112949699755780593311").Neg(),
		MustNewBigDecFromStr("0.052724071627342653404436933178482287"),
		MustNewBigDecFromStr("0.004760950735524957576233524801866342").Neg(),
		MustNewBigDecFromStr("0.000267168475410566529819971616894193"),
		MustNewBigDecFromStr("0.000008923715368802211181557353097439").Neg(),
		MustNewBigDecFromStr("0.000000140277233177373698516010555916"),
	}
	...
	maxSupportedExponent = MustNewBigDecFromStr("2").PowerInteger(9)
)
