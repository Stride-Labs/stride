...
import (
	...
	"github.com/Stride-Labs/stride/v33/x/icqoracle/keeper"
...
func (s *KeeperTestSuite) MustGetTokenPrice(baseDenom, quoteDenom string, osmosisPoolId uint64) types.TokenPrice {
