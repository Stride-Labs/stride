...
```go
  GetDistributorAccountBalance(ctx sdk.Context, airdropIdentifier string) (sdk.Coin, error)
  EndAirdrop(ctx sdk.Context, airdropIdentifier string) error
  GetClaimRecord(ctx sdk.Context, addr sdk.AccAddress, airdropIdentifier string) (types.ClaimRecord, error)
  GetClaimRecords(ctx sdk.Context, airdropIdentifier string) []types.ClaimRecord
  ...
  GetClaimableAmountForAction(ctx sdk.Context, addr sdk.AccAddress, action types.Action, airdropIdentifier string, includeClaimed bool) (sdk.Coins, error)
  GetUserTotalClaimable(ctx sdk.Context, addr sdk.AccAddress, airdropIdentifier string, includeClaimed bool) (sdk.Coins, error)
  ClaimCoinsForAction(ctx sdk.Context, addr sdk.AccAddress, action types.Action, airdropIdentifier string) (sdk.Coins, error)
  RemoveClaimRecords(ctx sdk.Context, airdropIdentifier string)
```
