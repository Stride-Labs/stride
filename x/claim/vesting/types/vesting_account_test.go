...
func TestGetVestedCoinsPeriodicVestingAcc(t *testing.T) {
	...
	periods := types.Periods{
		types.Period{StartTime: sdkmath.NewInt(now.Unix()), Length: sdkmath.NewInt(int64(12 * 60 * 60)), Amount: sdk.Coins{sdk.NewInt64Coin(feeDenom, 500), sdk.NewInt64Coin(stakeDenom, 50)}},
		types.Period{StartTime: sdkmath.NewInt(now.Unix() + int64(12*60*60)), Length: sdkmath.NewInt(int64(6 * 60 * 60)), Amount: sdk.Coins{sdk.NewInt64Coin(feeDenom, 250), sdk.NewInt64Coin(stakeDenom, 25)}},
		types.Period{StartTime: sdkmath.NewInt(now.Unix() + int64(18*60*60)), Length: sdkmath.NewInt(int64(6 * 60 * 60)), Amount: sdk.Coins{sdk.NewInt64Coin(feeDenom, 250), sdk.NewInt64Coin(stakeDenom, 25)}},
	}
...
func TestSpendableCoinsPeriodicVestingAcc(t *testing.T) {
	...
	periods := types.Periods{
		types.Period{StartTime: sdkmath.NewInt(now.Unix()), Length: sdkmath.NewInt(int64(12 * 60 * 60)), Amount: sdk.Coins{sdk.NewInt64Coin(feeDenom, 500), sdk.NewInt64Coin(stakeDenom, 50)}},
		types.Period{StartTime: sdkmath.NewInt(now.Unix() + int64(12*60*60)), Length: sdkmath.NewInt(int64(6 * 60 * 60)), Amount: sdk.Coins{sdk.NewInt64Coin(feeDenom, 250), sdk.NewInt64Coin(stakeDenom, 25)}},
		types.Period{StartTime: sdkmath.NewInt(now.Unix() + int64(15*60*60)), Length: sdkmath.NewInt(int64(6 * 60 * 60)), Amount: sdk.Coins{sdk.NewInt64Coin(feeDenom, 250), sdk.NewInt64Coin(stakeDenom, 25)}},
	}
...
func TestStridePeriodicVestingAccountMarshal(t *testing.T) {
	...
	now := tmtime.Now()
	acc := types.NewStridePeriodicVestingAccount(baseAcc, coins, types.Periods{types.Period{sdkmath.NewInt(now.Unix()), sdkmath.NewInt(3600), coins, 0}})
