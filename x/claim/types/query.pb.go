...
import (
	context "context"
	fmt "fmt"
	types2 "github.com/Stride-Labs/stride/v21/x/claim/vesting/types"
...
var fileDescriptor_baa87682a02846df = []byte{
	...
	0x62, 0xa4, 0x66, 0xb7, 0x75, 0x11, 0x07, 0x2e, 0xc0, 0x86, 0x8f, 0x06, 0x15, 0xa9, 0x6c, 0x4a,
	...
	,
	...
	,
}
