...
func (k Keeper) GetDistributorAccountBalance(ctx sdk.Context, airdropIdentifier string) (sdk.Coin, error) {
	...
	if airdrop == nil {
		return sdk.Coin{}, sdkerrors.Wrapf(legacysdkerrors.ErrInvalidAddress, "invalid airdrop identifier: GetDistributorAccountBalance")
	}
...
func (k Keeper) GetAirdropDistributor(ctx sdk.Context, airdropIdentifier string) (sdk.AccAddress, error) {
	airdrop := k.GetAirdropByIdentifier(ctx, airdropIdentifier)
	if airdrop == nil {
		return sdk.AccAddress{}, sdkerrors.Wrapf(legacysdkerrors.ErrInvalidAddress, "invalid airdrop identifier: GetAirdropDistributor")
	}
...
func (k Keeper) GetAirdropClaimDenom(ctx sdk.Context, airdropIdentifier string) (string, error) {
	airdrop := k.GetAirdropByIdentifier(ctx, airdropIdentifier)
	if airdrop == nil {
		return "", sdkerrors.Wrapf(legacysdkerrors.ErrInvalidRequest, "invalid airdrop identifier: GetAirdropClaimDenom")
	}
...
func (k Keeper) AfterClaim(ctx sdk.Context, airdropIdentifier string, claimAmount sdkmath.Int) error {
	...
	airdrop := k.GetAirdropByIdentifier(ctx, airdropIdentifier)
	if airdrop == nil {
		return sdkerrors.Wrapf(legacysdkerrors.ErrInvalidRequest, "invalid airdrop identifier: AfterClaim")
	}
...
func (k Keeper) ClaimCoinsForAction(ctx sdk.Context, addr sdk.AccAddress, action types.Action, airdropIdentifier string) (sdk.Coins, error) {
	...
	if airdropIdentifier == "" {
		return nil, sdkerrors.Wrapf(legacysdkerrors.ErrInvalidRequest, "invalid airdrop identifier: ClaimCoinsForAction")
	}
	...
	if !isPassed {
		...
		if !isStrideVestingAccount {
			...
			if _, ok := baseAccount.(*authtypes.BaseAccount); !ok {
				return nil, sdkerrors.Wrapf(legacysdkerrors.ErrInvalidRequest, "invalid account type; expected: BaseAccount, got: %T", baseAccount)
			}
