...
// source: stride/ibcratelimit/ibcratelimit.proto
...
func (PacketDirection) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_80e4cff8f40d5682, []int{0}
}
...
func (FlowDirection) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_80e4cff8f40d5682, []int{1}
}
...
func (*Flow) Descriptor() ([]byte, []int) {
	return fileDescriptor_80e4cff8f40d5682, []int{2}
}
...
func (*RateLimit) Descriptor() ([]byte, []int) {
	return fileDescriptor_80e4cff8f40d5682, []int{3}
}
...
func init() {
	proto.RegisterEnum("stride.ibcratelimit.PacketDirection", PacketDirection_name, PacketDirection_value)
	proto.RegisterEnum("stride.ibcratelimit.FlowDirection", FlowDirection_name, FlowDirection_value)
	proto.RegisterType((*Path)(nil), "stride.ibcratelimit.Path")
	proto.RegisterType((*Quota)(nil), "stride.ibcratelimit.Quota")
	proto.RegisterType((*Flow)(nil), "stride.ibcratelimit.Flow")
	proto.RegisterType((*RateLimit)(nil), "stride.ibcratelimit.RateLimit")
}

func init() {
	proto.RegisterFile("stride/ibcratelimit/ibcratelimit.proto", fileDescriptor_80e4cff8f40d5682)
}

var fileDescriptor_80e4cff8f40d5682 = []byte{
	// 505 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Path) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ChannelId) > 0 {
		...
		i = encodeVarintIbcratelimit(dAtA, i, uint64(len(m.ChannelId)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Denom) > 0 {
		i -= len(m.Denom)
		copy(dAtA[i:], m.Denom)
		i = encodeVarintIbcratelimit(dAtA, i, uint64(len(m.Denom)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Id) > 0 {
		i -= len(m.Id)
		copy(dAtA[i:], m.Id)
		i = encodeVarintIbcratelimit(dAtA, i, uint64(len(m.Id)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *Quota) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.PeriodEnd != 0 {
		i = encodeVarintIbcratelimit(dAtA, i, uint64(m.PeriodEnd))
		i--
		dAtA[i] = 0x28
	}
	if m.DurationHours != 0 {
		i = encodeVarintIbcratelimit(dAtA, i, uint64(m.DurationHours))
		i--
		dAtA[i] = 0x20
	}
	if m.MaxPercentRecv != 0 {
		i = encodeVarintIbcratelimit(dAtA, i, uint64(m.MaxPercentRecv))
		i--
		dAtA[i] = 0x18
	}
	if m.MaxPercentSend != 0 {
		i = encodeVarintIbcratelimit(dAtA, i, uint64(m.MaxPercentSend))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Name) > 0 {
		i -= len(m.Name)
		copy(dAtA[i:], m.Name)
		i = encodeVarintIbcratelimit(dAtA, i, uint64(len(m.Name)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Flow) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.ChannelValue != 0 {
		i = encodeVarintIbcratelimit(dAtA, i, uint64(m.ChannelValue))
		i--
		dAtA[i] = 0x18
	}
	if m.OutFlow != 0 {
		i = encodeVarintIbcratelimit(dAtA, i, uint64(m.OutFlow))
		i--
		dAtA[i] = 0x10
	}
	if m.InFlow != 0 {
		i = encodeVarintIbcratelimit(dAtA, i, uint64(m.InFlow))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Quota) Size() (n int) {
	...
	if m.MaxPercentSend != 0 {
		n += 1 + sovIbcratelimit(uint64(m.MaxPercentSend))
	}
	if m.MaxPercentRecv != 0 {
		n += 1 + sovIbcratelimit(uint64(m.MaxPercentRecv))
	}
	if m.DurationHours != 0 {
		n += 1 + sovIbcratelimit(uint64(m.DurationHours))
	}
	if m.PeriodEnd != 0 {
		n += 1 + sovIbcratelimit(uint64(m.PeriodEnd))
	}
	return n
}
...
func (m *Flow) Size() (n int) {
	...
	_ = l
	if m.InFlow != 0 {
		n += 1 + sovIbcratelimit(uint64(m.InFlow))
	}
	if m.OutFlow != 0 {
		n += 1 + sovIbcratelimit(uint64(m.OutFlow))
	}
	if m.ChannelValue != 0 {
		n += 1 + sovIbcratelimit(uint64(m.ChannelValue))
	}
	return n
}
