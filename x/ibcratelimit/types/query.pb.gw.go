...
var (
	pattern_Query_Paths_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"ibcratelimit", "paths"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Path_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"ibcratelimit", "path", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_RateLimits_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"ibcratelimit", "ratelimits"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_RateLimit_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"ibcratelimit", "ratelimit", "path_id"}, "", runtime.AssumeColonVerbOpt(true)))
)
