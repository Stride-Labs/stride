...
func (im IBCModule) OnChanOpenAck(
	...
	case portID == withdrawalAddress:
		zoneInfo.WithdrawalAccount = &types.ICAAccount{Address: address, UndelegatedBalance: 0, DelegatedBalance: 0, Target: types.ICAAccountType_WITHDRAWAL}
	// fee address
	case portID == feeAddress:
		zoneInfo.FeeAccount = &types.ICAAccount{Address: address, UndelegatedBalance: 0, DelegatedBalance: 0, Target: types.ICAAccountType_FEE}
	// delegation address
	case portID == delegationAddress:
		zoneInfo.DelegationAccount = &types.ICAAccount{Address: address, UndelegatedBalance: 0, DelegatedBalance: 0, Target: types.ICAAccountType_DELEGATION}
	default:
