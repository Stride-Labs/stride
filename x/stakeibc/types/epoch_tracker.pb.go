...
type EpochTracker struct {
	...
	NextEpochStartTime int64  `protobuf:"varint,3,opt,name=nextEpochStartTime,proto3" json:"nextEpochStartTime,omitempty"`
...
func (m *EpochTracker) GetNextEpochStartTime() int64 {
	if m != nil {
...
func (m *EpochTracker) GetDuration() int64 {
	if m != nil {
		return m.Duration
	}
	return 0
...
var fileDescriptor_cb60348ee619708f = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NextEpochStartTime |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
