...
type Params struct {
	...
	MaxRedemptionRates               map[string]string `protobuf:"bytes,19,rep,name=max_redemption_rates,json=maxRedemptionRates,proto3" json:"max_redemption_rates,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	MinRedemptionRates               map[string]string `protobuf:"bytes,20,rep,name=min_redemption_rates,json=minRedemptionRates,proto3" json:"min_redemption_rates,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *Params) GetMaxRedemptionRates() map[string]string {
	if m != nil {
		return m.MaxRedemptionRates
	}
	return nil
}

func (m *Params) GetMinRedemptionRates() map[string]string {
	if m != nil {
		return m.MinRedemptionRates
	}
	return nil
}
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "stride.stakeibc.Params.MaxRedemptionRatesEntry")
	proto.RegisterMapType((map[string]string)(nil), "stride.stakeibc.Params.MinRedemptionRatesEntry")
...
var fileDescriptor_5aeaab6a38c2b438 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.MinRedemptionRates) > 0 {
		for k := range m.MinRedemptionRates {
			v := m.MinRedemptionRates[k]
			baseI := i
			i -= len(v)
			copy(dAtA[i:], v)
	...
	if len(m.MaxRedemptionRates) > 0 {
		for k := range m.MaxRedemptionRates {
			v := m.MaxRedemptionRates[k]
			baseI := i
			i -= len(v)
			copy(dAtA[i:], v)
			i = encodeVarintParams(dAtA, i, uint64(len(v)))
...
func (m *Params) Size() (n int) {
	...
	if len(m.MaxRedemptionRates) > 0 {
		for k, v := range m.MaxRedemptionRates {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovParams(uint64(len(k))) + 1 + len(v) + sovParams(uint64(len(v)))
			n += mapEntrySize + 2 + sovParams(uint64(mapEntrySize))
		}
	}
	if len(m.MinRedemptionRates) > 0 {
		for k, v := range m.MinRedemptionRates {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovParams(uint64(len(k))) + 1 + len(v) + sovParams(uint64(len(v)))
			n += mapEntrySize + 2 + sovParams(uint64(mapEntrySize))
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxRedemptionRates", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.MaxRedemptionRates == nil {
				m.MaxRedemptionRates = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.MaxRedemptionRates[mapkey] = mapvalue
			iNdEx = postIndex
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinRedemptionRates", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.MinRedemptionRates == nil {
				m.MinRedemptionRates = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.MinRedemptionRates[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipParams(dAtA[iNdEx:])
