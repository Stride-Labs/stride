...
// source: stride/stakeibc/v1/host_zone.proto
...
type HostZone struct {
	...
	BlacklistedValidators []*types.Validator `protobuf:"bytes,4,rep,name=blacklisted_validators,json=blacklistedValidators,proto3" json:"blacklisted_validators,omitempty"`
	WithdrawalAccount     *types.ICAAccount  `protobuf:"bytes,5,opt,name=withdrawal_account,json=withdrawalAccount,proto3" json:"withdrawal_account,omitempty"`
	FeeAccount            *types.ICAAccount  `protobuf:"bytes,6,opt,name=fee_account,json=feeAccount,proto3" json:"fee_account,omitempty"`
	DelegationAccount     *types.ICAAccount  `protobuf:"bytes,7,opt,name=delegation_account,json=delegationAccount,proto3" json:"delegation_account,omitempty"`
	RedemptionAccount     *types.ICAAccount  `protobuf:"bytes,16,opt,name=redemption_account,json=redemptionAccount,proto3" json:"redemption_account,omitempty"`
	// ibc denom on stride
...
func (*HostZone) Descriptor() ([]byte, []int) {
	return fileDescriptor_ae8aafcde3b9fa83, []int{0}
}
...
func (m *HostZone) GetValidators() []*types.Validator {
	if m != nil {
		return m.Validators
	}
	return nil
...
func (m *HostZone) GetBlacklistedValidators() []*types.Validator {
	if m != nil {
...
func (m *HostZone) GetWithdrawalAccount() *types.ICAAccount {
	if m != nil {
...
func (m *HostZone) GetFeeAccount() *types.ICAAccount {
	if m != nil {
		return m.FeeAccount
	}
	return nil
...
func (m *HostZone) GetDelegationAccount() *types.ICAAccount {
	if m != nil {
...
func (m *HostZone) GetRedemptionAccount() *types.ICAAccount {
	if m != nil {
...
func init() {
	proto.RegisterType((*HostZone)(nil), "stride.stakeibc.v1.HostZone")
}

func init() {
	proto.RegisterFile("stride/stakeibc/v1/host_zone.proto", fileDescriptor_ae8aafcde3b9fa83)
}

var fileDescriptor_ae8aafcde3b9fa83 = []byte{
	...
	,
}
...
func (m *HostZone) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.BlacklistedValidators = append(m.BlacklistedValidators, &types.Validator{})
		...
		case 5:
			...
			if m.WithdrawalAccount == nil {
				m.WithdrawalAccount = &types.ICAAccount{}
			}
		...
		case 7:
			...
			if m.DelegationAccount == nil {
				m.DelegationAccount = &types.ICAAccount{}
			}
		...
		case 16:
			...
			if m.RedemptionAccount == nil {
				m.RedemptionAccount = &types.ICAAccount{}
			}
