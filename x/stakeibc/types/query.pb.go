...
type QueryLSMDepositsRequest struct {
	...
	//	*QueryLSMDepositsRequest_Status
	XStatus isQueryLSMDepositsRequest_XStatus `protobuf_oneof:"_status"`
	// Types that are valid to be assigned to XDenom:
	//	*QueryLSMDepositsRequest_Denom
	XDenom isQueryLSMDepositsRequest_XDenom `protobuf_oneof:"_denom"`
}
...
type isQueryLSMDepositsRequest_XStatus interface {
	isQueryLSMDepositsRequest_XStatus()
	MarshalTo([]byte) (int, error)
	Size() int
}
type isQueryLSMDepositsRequest_XDenom interface {
	isQueryLSMDepositsRequest_XDenom()
	MarshalTo([]byte) (int, error)
	Size() int
}

type QueryLSMDepositsRequest_Status struct {
	Status string `protobuf:"bytes,2,opt,name=status,proto3,oneof" json:"status,omitempty"`
}
type QueryLSMDepositsRequest_Denom struct {
	Denom string `protobuf:"bytes,3,opt,name=denom,proto3,oneof" json:"denom,omitempty"`
}

func (*QueryLSMDepositsRequest_Status) isQueryLSMDepositsRequest_XStatus() {}
func (*QueryLSMDepositsRequest_Denom) isQueryLSMDepositsRequest_XDenom()   {}

func (m *QueryLSMDepositsRequest) GetXStatus() isQueryLSMDepositsRequest_XStatus {
	if m != nil {
		return m.XStatus
	}
	return nil
}
func (m *QueryLSMDepositsRequest) GetXDenom() isQueryLSMDepositsRequest_XDenom {
	if m != nil {
		return m.XDenom
	}
	return nil
...
func (m *QueryLSMDepositsRequest) GetStatus() string {
	if x, ok := m.GetXStatus().(*QueryLSMDepositsRequest_Status); ok {
		return x.Status
	}
	return ""
}

func (m *QueryLSMDepositsRequest) GetDenom() string {
	if x, ok := m.GetXDenom().(*QueryLSMDepositsRequest_Denom); ok {
		return x.Denom
	}
	return ""
}
...
func (*QueryLSMDepositsRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*QueryLSMDepositsRequest_Status)(nil),
		(*QueryLSMDepositsRequest_Denom)(nil),
	}
}

type QueryLSMDepositsResponse struct {
	LsmDeposit []LSMTokenDeposit `protobuf:"bytes,1,rep,name=lsm_deposit,json=lsmDeposit,proto3" json:"lsm_deposit"`
}
...
func (m *QueryLSMDepositsResponse) GetLsmDeposit() []LSMTokenDeposit {
	if m != nil {
		return m.LsmDeposit
	}
	return nil
...
var fileDescriptor_494b786fe66f2b80 = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// Queries the existing LSMTokenDeposits with different filters
...
func (m *QueryLSMDepositsRequest_Status) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryLSMDepositsRequest_Status) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.Status)
...
func (m *QueryLSMDepositsRequest_Denom) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryLSMDepositsRequest_Denom) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.Denom)
	copy(dAtA[i:], m.Denom)
...
func (m *QueryLSMDepositsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.LsmDeposit) > 0 {
		for iNdEx := len(m.LsmDeposit) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.LsmDeposit[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *QueryLSMDepositsRequest_Status) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryLSMDepositsRequest_Denom) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryLSMDepositsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.XStatus = &QueryLSMDepositsRequest_Status{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.XDenom = &QueryLSMDepositsRequest_Denom{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
...
func (m *QueryLSMDepositsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LsmDeposit", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LsmDeposit = append(m.LsmDeposit, LSMTokenDeposit{})
			if err := m.LsmDeposit[len(m.LsmDeposit)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
