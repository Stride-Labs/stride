...
type DelegateCallback struct {
	...
	DepositRecordId string `protobuf:"bytes,2,opt,name=depositRecordId,proto3" json:"depositRecordId,omitempty"`
}
...
func (m *DelegateCallback) GetDepositRecordId() string {
	if m != nil {
...
var fileDescriptor_73c938d1f08de4bf = []byte{
	...
	,
}
...
func (m *DelegateCallback) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.DepositRecordId) > 0 {
		i -= len(m.DepositRecordId)
		copy(dAtA[i:], m.DepositRecordId)
		i = encodeVarintCallbacks(dAtA, i, uint64(len(m.DepositRecordId)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *DelegateCallback) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.DepositRecordId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
