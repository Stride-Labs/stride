...
var (
	...
	ErrInvalidBounds                       = errorsmod.Register(ModuleName, 1553, "Invalid safety bounds - inner bounds must be within outer bounds")
	ErrHostZoneNotHalted                   = errorsmod.Register(ModuleName, 1554, "host zone is not halted")
	ErrFailedToLiquidStake                 = errorsmod.Register(ModuleName, 1555, "Failed to liquid stake")
	ErrUnableToRedeemStake                 = errorsmod.Register(ModuleName, 1556, "Failed to redeem stake")
)
