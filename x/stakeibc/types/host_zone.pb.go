...
func (m *ControllerBalances) GetIndex() int64 {
	if m != nil {
		return m.Index
	}
	return 0
...
var fileDescriptor_a1d300c62c2b2d54 = []byte{
	...
	,
}
...
func (m *ControllerBalances) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Index != 0 {
		i = encodeVarintHostZone(dAtA, i, uint64(m.Index))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *ControllerBalances) Size() (n int) {
	...
	_ = l
	if m.Index != 0 {
		n += 1 + sovHostZone(uint64(m.Index))
	}
	if m.Height != 0 {
