...
type HostZone struct {
	...
	StakedBal string `protobuf:"bytes,13,opt,name=staked_bal,json=stakedBal,proto3" json:"staked_bal,omitempty"`
...
func (m *HostZone) GetStakedBal() string {
	if m != nil {
		return m.StakedBal
	}
	return ""
...
var fileDescriptor_f81bf5b42c61245a = []byte{
	...
	0x92, 0x36, 0x25, 0x95, 0x3d, 0x12, 0xe2, 0x37, 0xa8, 0x4c, 0x18, 0x8b, 0x40, 0x29, 0x1b, 0x9b,
	0xe5, 0xe2, 0xbf, 0xd7, 0x8d, 0xf9, 0x0b, 0x32, 0x08, 0xb7, 0x5b, 0xa9, 0xd0, 0xf2, 0x32, 0xcb,
	0xe1, 0x74, 0x65, 0x61, 0x71, 0x71, 0xef, 0xc3, 0xe5, 0x4d, 0xdd, 0xba, 0xba, 0xa9, 0x5b, 0xbf,
	0x6f, 0xea, 0xd6, 0xb7, 0xdb, 0x7a, 0xe9, 0xea, 0xb6, 0x5e, 0xfa, 0x79, 0x5b, 0x2f, 0x1d, 0xbf,
	0x2d, 0xec, 0xf1, 0xb3, 0x39, 0xea, 0x8d, 0x8f, 0x24, 0x50, 0x6e, 0xfa, 0xda, 0x9c, 0x6e, 0xb9,
	0xe7, 0xf9, 0x93, 0x63, 0xb6, 0x1c, 0xcc, 0x98, 0xc7, 0x63, 0xeb, 0x5f, 0x00, 0x00, 0x00, 0xff,
	0xff, 0x45, 0xc0, 0x04, 0xf5, 0xe5, 0x04, 0x00, 0x00,
}
...
func (m *HostZone) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.StakedBal) > 0 {
		i -= len(m.StakedBal)
		copy(dAtA[i:], m.StakedBal)
		i = encodeVarintHostZone(dAtA, i, uint64(len(m.StakedBal)))
		i--
		dAtA[i] = 0x6a
	}
...
func (m *HostZone) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			...
			m.StakedBal = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 14:
			if wireType != 0 {
