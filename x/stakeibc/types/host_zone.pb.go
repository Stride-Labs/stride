...
const (
	BALANCED_DELEGATION   DelegationType = 0
	UNBALANCED_DELEGATION DelegationType = 1
)

var DelegationType_name = map[int32]string{
	0: "BALANCED_DELEGATION",
	1: "UNBALANCED_DELEGATION",
}

var DelegationType_value = map[string]int32{
	"BALANCED_DELEGATION":   0,
	"UNBALANCED_DELEGATION": 1,
}
...
var fileDescriptor_f81bf5b42c61245a = []byte{
	...
	,
}
