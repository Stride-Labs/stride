...
type HostZone struct {
	...
	// TODO handle init in migrator
	LockupAddress string `protobuf:"bytes,19,opt,name=lockup_address,json=lockupAddress,proto3" json:"lockup_address,omitempty" yaml:"address"`
	// unbonding_time is the time duration of unbonding.
	UnbondingTime time.Duration `protobuf:"bytes,20,opt,name=unbonding_time,json=unbondingTime,proto3,stdduration" json:"unbonding_time"`
}
...
func (m *HostZone) GetLockupAddress() string {
	if m != nil {
...
func (m *HostZone) GetUnbondingTime() time.Duration {
	if m != nil {
...
var fileDescriptor_f81bf5b42c61245a = []byte{
	...
	,
}
...
func (m *HostZone) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i -= n1
	i = encodeVarintHostZone(dAtA, i, uint64(n1))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0xa2
	if len(m.LockupAddress) > 0 {
		...
		i = encodeVarintHostZone(dAtA, i, uint64(len(m.LockupAddress)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x9a
