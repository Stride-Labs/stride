...
type MsgRegisterHostZone struct {
	...
	UnbondingFrequency github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,11,opt,name=unbonding_frequency,json=unbondingFrequency,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"unbonding_frequency" yaml:"unbonding_frequency"`
}
...
type MsgRebalanceValidators struct {
	...
	NumRebalance github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=num_rebalance,json=numRebalance,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"num_rebalance"`
}
...
type MsgAddValidator struct {
	...
	Commission github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,5,opt,name=commission,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"commission"`
...
type MsgChangeValidatorWeight struct {
	...
	Weight   github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,4,opt,name=weight,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"weight"`
}
...
var fileDescriptor_9b7e09c9ad51cd54 = []byte{
	...
	,
}
...
func (m *MsgRebalanceValidators) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.NumRebalance.Size()
		i -= size
		if _, err := m.NumRebalance.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintTx(dAtA, i, uint64(size))
	}
...
func (m *MsgRebalanceValidators) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if err := m.NumRebalance.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
