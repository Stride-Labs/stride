...
type MsgLSMLiquidStake struct {
	Creator       string                                 `protobuf:"bytes,1,opt,name=creator,proto3" json:"creator,omitempty"`
	Amount        github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,2,opt,name=amount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"amount"`
	LsmTokenDenom string                                 `protobuf:"bytes,3,opt,name=lsm_token_denom,json=lsmTokenDenom,proto3" json:"lsm_token_denom,omitempty"`
}
...
func (m *MsgLSMLiquidStake) GetLsmTokenDenom() string {
	if m != nil {
		return m.LsmTokenDenom
	}
	return ""
}
...
var fileDescriptor_9b7e09c9ad51cd54 = []byte{
	...
	,
}
...
func (m *MsgLSMLiquidStake) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.LsmTokenDenom) > 0 {
		i -= len(m.LsmTokenDenom)
		copy(dAtA[i:], m.LsmTokenDenom)
		i = encodeVarintTx(dAtA, i, uint64(len(m.LsmTokenDenom)))
		i--
		dAtA[i] = 0x1a
	}
	{
...
func (m *MsgLSMLiquidStake) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LsmTokenDenom", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LsmTokenDenom = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
