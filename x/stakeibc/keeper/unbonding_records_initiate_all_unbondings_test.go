...
func (s *KeeperTestSuite) SetupInitiateAllHostZoneUnbondings() InitiateAllHostZoneUnbondingsTestCase {
	...
	gaiaValidators := []*stakeibc.Validator{
		...
		},
		{
			...
			DelegationAmt: cosmosmath.NewInt(3_000_000),
			Weight:        uint64(6),
		},
	}
	...
	default_unbonding := []*recordtypes.HostZoneUnbonding{
		{
			...
			StTokenAmount:     cosmosmath.NewInt(1_900_000),
		...
		},
		{
			...
			StTokenAmount:      cosmosmath.NewInt(2_800_000),
			NativeTokenAmount: cosmosmath.NewInt(3),
			Denom:             Osmo,
			Status:            recordtypes.HostZoneUnbonding_UNBONDING_QUEUE,
		},
	}
	...
	hostZone.Validators = []*stakeibc.Validator{
		{
			...
			DelegationAmt: cosmosmath.NewInt(1_000_000),
			Weight:        uint64(10),
		},
	}
	s.App.StakeibcKeeper.SetHostZone(s.Ctx, hostZone)
