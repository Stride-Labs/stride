...
func (s *KeeperTestSuite) SetupInitiateAllHostZoneUnbondings() InitiateAllHostZoneUnbondingsTestCase {
	...
	epochUnbondingRecords := []recordtypes.EpochUnbondingRecord{}
	for _, epochNumber := range []sdkmath.Int{sdkmath.NewInt(5)} {
...
func (s *KeeperTestSuite) TestInitiateAllHostZoneUnbondings_Successful() {
	...
	success, successful_unbondings, failed_unbondings := s.App.StakeibcKeeper.InitiateAllHostZoneUnbondings(s.Ctx, sdkmath.NewInt(12))
...
func (s *KeeperTestSuite) TestInitiateAllHostZoneUnbondings_GaiaSuccessful() {
	...
	s.SetupInitiateAllHostZoneUnbondings()
	success, successful_unbondings, failed_unbondings := s.App.StakeibcKeeper.InitiateAllHostZoneUnbondings(s.Ctx, sdkmath.NewInt(9))
...
func (s *KeeperTestSuite) TestInitiateAllHostZoneUnbondings_OsmoSuccessful() {
	...
	s.SetupInitiateAllHostZoneUnbondings()
	success, successful_unbondings, failed_unbondings := s.App.StakeibcKeeper.InitiateAllHostZoneUnbondings(s.Ctx, sdkmath.NewInt(8))
...
func (s *KeeperTestSuite) TestInitiateAllHostZoneUnbondings_NoneSuccessful() {
	...
	s.SetupInitiateAllHostZoneUnbondings()
	success, successful_unbondings, failed_unbondings := s.App.StakeibcKeeper.InitiateAllHostZoneUnbondings(s.Ctx, sdkmath.NewInt(10))
