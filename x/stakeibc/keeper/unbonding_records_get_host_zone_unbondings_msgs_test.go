...
func (s *KeeperTestSuite) TestUnbondFromHostZone_Successful_HubUnbondingsTest() {
	validators := []*types.Validator{
		...
		{Address: "citadelone", Weight: 2869, Delegation: sdkmath.NewInt(196609485155)},
		...
		{Address: "imperator", Weight: 347, Delegation: sdkmath.NewInt(15147607350)},
		...
		{Address: "sg1", Weight: 593, Delegation: sdkmath.NewInt(26291549170)},
		...
		{Address: "stakefish", Weight: 73, Delegation: sdkmath.NewInt(2833319160)},
		...
		{Address: "prodelegators", Weight: 276, Delegation: sdkmath.NewInt(11968441720)},
