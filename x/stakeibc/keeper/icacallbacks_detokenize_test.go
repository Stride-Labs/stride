...
type DetokenizeCallbackTestCase struct {
	...
	expectedValidatorDelegationWithStrictUnbondingCap int64
	expectedTotalDelegationWithStrictUnbondingCap     int64
...
func (s *KeeperTestSuite) SetupTestDetokenizeCallback(ackStatus icacallbacktypes.AckResponseStatus) DetokenizeCallbackTestCase {
	...
	// because we have a branch around the StrictUnbondingCap, we need to test both cases
	expectedValidatorDelegationWithStrictUnbondingCap := int64(5999) // 5000 + 999
	expectedTotalDelegationWithStrictUnbondingCap := int64(10999)    // 10000 + 999
	...
	// Build the ack response, to test
	...
	return DetokenizeCallbackTestCase{
		...
		expectedValidatorDelegationWithStrictUnbondingCap: expectedValidatorDelegationWithStrictUnbondingCap,
		expectedTotalDelegationWithStrictUnbondingCap:     expectedTotalDelegationWithStrictUnbondingCap,
