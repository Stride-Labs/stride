...
func (k Keeper) GetUndelegatedBalance(hostZone types.HostZone, depositRecords []recordstypes.DepositRecord) (cosmosmath.Int, error) {
	...
	totalAmount := cosmosmath.ZeroInt()
...
func (k Keeper) GetModuleAccountBalance(hostZone types.HostZone, depositRecords []recordstypes.DepositRecord) (cosmosmath.Int, error) {
