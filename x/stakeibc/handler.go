...
func NewHandler(k keeper.Keeper) sdk.Handler {
	...
	return func(ctx sdk.Context, msg sdk.Msg) (*sdk.Result, error) {
		...
		default:
			...
			return nil, fmt.Errorf("%s: %s", errMsg, stakeibctypes.ErrUnknownRequest.Error())
		}
	}
}
...
func NewAddValidatorProposalHandler(k keeper.Keeper) govtypes.Handler {
	...
	return func(ctx sdk.Context, content govtypes.Content) error {
		...
		default:
			return fmt.Errorf("unrecognized addValidator proposal content type: %T: %s", c, stakeibctypes.ErrUnknownRequest.Error())
		}
	}
}
