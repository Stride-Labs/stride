...
type Params struct {
	...
	// mint rewards evert epoch_interval epochs
	EpochInterval uint64 `protobuf:"varint,9,opt,name=epoch_interval,json=epochInterval,proto3" json:"epoch_interval,omitempty"`
	...
	StrategicReserveAddress              string `protobuf:"bytes,8,opt,name=strategic_reserve_address,json=strategicReserveAddress,proto3" json:"strategic_reserve_address,omitempty" yaml:"address"`
}
...
func (m *Params) GetStrategicReserveAddress() string {
	if m != nil {
		return m.StrategicReserveAddress
	}
	return ""
}
...
var fileDescriptor_06339c129491fd39 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.EpochInterval != 0 {
		i = encodeVarintMint(dAtA, i, uint64(m.EpochInterval))
		i--
		dAtA[i] = 0x48
	}
	if len(m.StrategicReserveAddress) > 0 {
		i -= len(m.StrategicReserveAddress)
		copy(dAtA[i:], m.StrategicReserveAddress)
		i = encodeVarintMint(dAtA, i, uint64(len(m.StrategicReserveAddress)))
		i--
		dAtA[i] = 0x42
	}
...
func (m *Params) Size() (n int) {
	...
	l = len(m.StrategicReserveAddress)
	if l > 0 {
		n += 1 + l + sovMint(uint64(l))
	}
	if m.EpochInterval != 0 {
		n += 1 + sovMint(uint64(m.EpochInterval))
	}
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StrategicReserveAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StrategicReserveAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 9:
			if wireType != 0 {
