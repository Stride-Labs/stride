...
Mint module mint ST tokens at the end of epochs.
On the other hand, module allocate tokens to ST stakers, pool incentives, developer rewards, and community pool.
