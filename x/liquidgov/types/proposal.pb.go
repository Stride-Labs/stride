...
type Proposal struct {
	...
	GovProposal *v1beta1.Proposal `protobuf:"bytes,2,opt,name=gov_proposal,json=govProposal,proto3" json:"gov_proposal,omitempty"`
}
...
var fileDescriptor_bc4080bd70e79af4 = []byte{
	...
	0x98, 0xa9, 0x4e, 0x2c, 0x27, 0xee, 0xc9, 0x33, 0x06, 0x71, 0xa7, 0xe7, 0x97, 0xc1, 0x85, 0x7c,
	...
	0x1b, 0xd8, 0x2b, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xa1, 0x6c, 0xeb, 0x94, 0x4e, 0x01,
	0x00, 0x00,
}
...
func (m *Proposal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.GovProposal == nil {
				m.GovProposal = &v1beta1.Proposal{}
			}
