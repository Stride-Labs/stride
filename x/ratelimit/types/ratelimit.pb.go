...
type Path struct {
	...
	// path base_denom - represenets the underlying denom (ignoring ibc traces)
	BaseDenom string `protobuf:"bytes,2,opt,name=base_denom,json=baseDenom,proto3" json:"base_denom,omitempty"`
	// path trace_denom - true denom (either ustrd or an ibc hash)
	TraceDenom string `protobuf:"bytes,3,opt,name=trace_denom,json=traceDenom,proto3" json:"trace_denom,omitempty"`
	// path channelid
...
func (m *Path) GetTraceDenom() string {
	if m != nil {
		return m.TraceDenom
	}
	return ""
...
var fileDescriptor_a3e00ee2c967d747 = []byte{
	...
	,
}
...
func (m *Path) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TraceDenom) > 0 {
		i -= len(m.TraceDenom)
		copy(dAtA[i:], m.TraceDenom)
		i = encodeVarintRatelimit(dAtA, i, uint64(len(m.TraceDenom)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *Path) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TraceDenom", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TraceDenom = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
