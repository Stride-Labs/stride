...
func (m *AddressWhitelist) Reset()         { *m = AddressWhitelist{} }
func (m *AddressWhitelist) String() string { return proto.CompactTextString(m) }
func (*AddressWhitelist) ProtoMessage()    {}
func (*AddressWhitelist) Descriptor() ([]byte, []int) {
	return fileDescriptor_a3e00ee2c967d747, []int{4}
}
func (m *AddressWhitelist) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AddressWhitelist) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AddressWhitelist.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AddressWhitelist) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddressWhitelist.Merge(m, src)
}
func (m *AddressWhitelist) XXX_Size() int {
	return m.Size()
}
func (m *AddressWhitelist) XXX_DiscardUnknown() {
	xxx_messageInfo_AddressWhitelist.DiscardUnknown(m)
}

var xxx_messageInfo_AddressWhitelist proto.InternalMessageInfo

func (m *AddressWhitelist) GetSender() string {
	if m != nil {
		return m.Sender
	}
	return ""
...
func (m *AddressWhitelist) GetReceiver() string {
	if m != nil {
		return m.Receiver
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*AddressWhitelist)(nil), "stride.ratelimit.AddressWhitelist")
}
...
var fileDescriptor_a3e00ee2c967d747 = []byte{
	...
	,
}
...
func (m *AddressWhitelist) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AddressWhitelist) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AddressWhitelist) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AddressWhitelist) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AddressWhitelist) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AddressWhitelist: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AddressWhitelist: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
