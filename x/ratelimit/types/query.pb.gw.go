...
var (
	...
	pattern_Query_Quotas_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"ratelimit", "quotas"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Quota_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"ratelimit", "quota", "name"}, "", runtime.AssumeColonVerbOpt(true)))
