...
var (
	...
	pattern_Query_RateLimit_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 1, 0, 4, 1, 5, 1, 1, 0, 4, 1, 5, 2}, []string{"ratelimit", "denom", "channel_id"}, "", runtime.AssumeColonVerbOpt(true)))
)
