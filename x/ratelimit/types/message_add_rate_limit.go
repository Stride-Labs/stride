...
func NewMsgAddRateLimit(creator string, denom string, channelId string, maxPercentSend sdk.Int, maxPercentRecv sdk.Int, durationHours uint64) *MsgAddRateLimit {
