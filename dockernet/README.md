...
### Integration test failure handling on local environment

Integration test used to fail on ibc-transfer, when old version of gaia and relayer is used on the dockernet.

To build the fresh environment for integration test, it is needed to run followings.
