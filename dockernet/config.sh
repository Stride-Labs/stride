...
IBC_PROVIDER_CHANNEL_0_DENOM='ibc/27394FB092D2ECCD56123C74F36E4C1F926001CEADA9CA97EA622B25F41E5EB2'
IBC_PROVIDER_CHANNEL_1_DENOM='ibc/C4CFF46FD6DE35CA4CF4CE031E643C8FDC9BA4B99AE598E9B0ED98FE3A2319F9'
IBC_PROVIDER_CHANNEL_2_DENOM='ibc/9117A26BA81E29FA4F78F57DC2BD90CD3D26848101BA880445F119B22A1E254E'
IBC_PROVIDER_CHANNEL_3_DENOM='ibc/A4DB47A9D3CF9A068D454513891B526702455D3EF08FB9EB558C561F9DC2B701'
...
PROVIDER_NODE_PREFIX=provider
PROVIDER_NUM_NODES=1
PROVIDER_BINARY="$DOCKERNET_HOME/../build/interchain-security-pd"
PROVIDER_VAL_PREFIX=pval
PROVIDER_REV_ACCT=prev1
PROVIDER_ADDRESS_PREFIX=cosmos
PROVIDER_DENOM=$PROVIDER_DENOM
PROVIDER_RPC_PORT=26257
PROVIDER_COIN_TYPE=$COSMOS_COIN_TYPE
PROVIDER_MAIN_CMD="$PROVIDER_BINARY --home $DOCKERNET_HOME/state/${PROVIDER_NODE_PREFIX}1"
PROVIDER_RECEIVER_ADDRESS='cosmos1g6qdx6kdhpf000afvvpte7hp0vnpzapuyxp8uf'
...
RELAYER_PROVIDER_EXEC="$DOCKER_COMPOSE run --rm relayer-provider"
...
RELAYER_PROVIDER_ACCT=rly7
RELAYER_ACCTS=($RELAYER_GAIA_ACCT $RELAYER_JUNO_ACCT $RELAYER_OSMO_ACCT $RELAYER_STARS_ACCT $RELAYER_HOST_ACCT $RELAYER_PROVIDER_ACCT)
...
RELAYER_PROVIDER_MNEMONIC="void foot mean urge butter negative eagle tide feature solar matter boy satoshi pistol cheap dizzy length good toss coach aunt budget submit poverty"
RELAYER_MNEMONICS=(
...
PROVIDER_ADDRESS() { 
  $PROVIDER_MAIN_CMD keys show ${PROVIDER_VAL_PREFIX}1 --keyring-backend test -a 
}
