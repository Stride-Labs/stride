...
INJECTIVE_BINARY="$DOCKER_COMPOSE run --rm injective1 injectived"
INJECTIVE_VAL_PREFIX=injval
INJECTIVE_ADDRESS_PREFIX=inj
INJECTIVE_REV_ACCT=injrev1
INJECTIVE_DENOM=$INJECTIVE_DENOM
INJECTIVE_RPC_PORT=26657
INJECTIVE_COIN_TYPE=$ETH_COIN_TYPE
INJECTIVE_MAIN_CMD="$DOCKER_COMPOSE exec -it $(docker ps -aqf "name=.*injective1.*") --rm injective1 injectived"
...
RELAYER_INJECTIVE_ACCT=rly7
RELAYER_ACCTS=($RELAYER_GAIA_ACCT $RELAYER_JUNO_ACCT $RELAYER_OSMO_ACCT $RELAYER_STARS_ACCT $RELAYER_HOST_ACCT $RELAYER_INJECTIVE_ACCT)
