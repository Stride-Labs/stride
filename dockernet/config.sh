...
EVMOS_NUM_NODES=1
EVMOS_CMD="$DOCKERNET_HOME/../build/evmosd"
...
EVMOS_MAIN_CMD="$EVMOS_CMD --home $DOCKERNET_HOME/state/${EVMOS_NODE_PREFIX}1"
# TODO: update README
...
HOST_RELAYER_ACCTS=($RELAYER_GAIA_ACCT $RELAYER_JUNO_ACCT $RELAYER_OSMO_ACCT $RELAYER_STARS_ACCT $RELAYER_EVMOS_ACCT $RELAYER_HOST_ACCT)
