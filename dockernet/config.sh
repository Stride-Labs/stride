...
# LSM (Simapp Running MsgLiquidStake)
LSM_CHAIN_ID=LSM
LSM_NODE_PREFIX=lsm
LSM_NUM_NODES=1
...
RELAYER_LSM_ACCT=rly7
RELAYER_ACCTS=($RELAYER_GAIA_ACCT $RELAYER_JUNO_ACCT $RELAYER_OSMO_ACCT $RELAYER_STARS_ACCT $RELAYER_HOST_ACCT, $RELAYER_LSM_ACCT)
...
RELAYER_LSM_MNEMONIC="science depart where tell bus ski laptop follow child bronze rebel recall brief plug razor ship degree labor human series today embody fury harvest"
RELAYER_MNEMONICS=(
