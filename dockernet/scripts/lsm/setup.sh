...
# echo $GAIA_MAIN_CMD q validators
...
$GAIA_MAIN_CMD tx bank send $($GAIA_MAIN_CMD keys show gval1 -a) $staker_lsm_address 2000000000000uatom --from rly8 -y | TRIM_TX 
sleep 5 && echo ""
...
$GAIA_MAIN_CMD tx staking delegate $validator_address 1500000000000uatom --from staker -y | TRIM_TX && echo ""
sleep 5
