...
# TEST 0.3 forfeiture
# claimer1=stride1qtzlx93h8xlmej42pjqyez6yp9nscfgxsmtt59
...
# $STRIDE_MAIN_CMD q bank balances stride1qtzlx93h8xlmej42pjqyez6yp9nscfgxsmtt59 --> 700001
# 700000 / 1000000 => 0.7


# TEST DISTRIBUTOR NOT FUNDED
# $STRIDE_MAIN_CMD q bank balances stride1wxv8jnusl5s2che9kp33jrsxz3kxcwm6fgfs0z
# $STRIDE_MAIN_CMD tx bank send stride1wxv8jnusl5s2che9kp33jrsxz3kxcwm6fgfs0z stride1v0t265yce4pwdvmzs4ew0ll4fnk2t6updfg6hf 4999300000ustrd --from distributor -y --gas 1000000 | TRIM_TX 
# $STRIDE_MAIN_CMD q bank balances stride1v0t265yce4pwdvmzs4ew0ll4fnk2t6updfg6hf
# $STRIDE_MAIN_CMD tx airdrop claim-early $AIRDROP_NAME --from claimer2 -y --gas 1000000 | TRIM_TX
# $STRIDE_MAIN_CMD q tx BC965ED7A2BAF680E2A082130DDD1B267F6CD56881279FF0D88BA7D64FA338AC
# raw_log: 'failed to execute message; message index: 0: unable to distribute rewards:
#   spendable balance  is smaller than 4900000ustrd: insufficient funds'
# timestamp: "2024-07-29T20:07:57Z"
