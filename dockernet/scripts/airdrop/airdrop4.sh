...
# create airdrop 1 with a 60 sec start window, 60 sec reset, claim, sleep 35
echo ">>> Creating a ustrd airdrop with 60 second reset window"
...
# create airdrop 2 with a 60 sec start window, 60 sec reset, claim, sleep 35
echo -e "\n>>> Creating an ibc/uatom airdrop with 60 second reset window"
...
# airdrop 1 resets
echo -e "\n>>> Query how many funds are vesting before the reset + re-claim"
