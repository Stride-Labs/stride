...
import { DistributionProportions } from "./module/types/mint/v1beta1/mint"
import { Params } from "./module/types/mint/v1beta1/mint"


export { Minter, DistributionProportions, Params };
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: stride.mint.v1beta1 initialized!')
