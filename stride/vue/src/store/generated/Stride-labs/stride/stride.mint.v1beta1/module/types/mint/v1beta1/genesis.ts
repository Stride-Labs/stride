...
export interface GenesisState {
  ...
  reduction_started_epoch: number;
}

const baseGenesisState: object = { reduction_started_epoch: 0 };
...
export const GenesisState = {
  encode(message: GenesisState, writer: Writer = Writer.create()): Writer {
    ...
    if (message.reduction_started_epoch !== 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.reduction_started_epoch = longToNumber(
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (
      ...
      message.reduction_started_epoch = Number(object.reduction_started_epoch);
    } else {
      message.reduction_started_epoch = 0;
    }
    return message;
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    message.reduction_started_epoch !== undefined &&
      (obj.reduction_started_epoch = message.reduction_started_epoch);
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<GenesisState>): GenesisState {
    ...
    if (
      ...
      message.reduction_started_epoch = object.reduction_started_epoch;
    } else {
      message.reduction_started_epoch = 0;
    }
    return message;
