...
docker-compose --ansi never exec -T stride1 strided tx stakeibc liquid-stake 1000 ibc/9117A26BA81E29FA4F78F57DC2BD90CD3D26848101BA880445F119B22A1E254E --keyring-backend test --home /stride/.strided --from val1 --chain-id STRIDE_1

# docker-compose --ansi never exec -T stride1 strided tx ibc-transfer transfer channel-1 cosmos1pcag0cj4ttxg8l7pcg0q4ksuglswuuedcextl2: 1000ustrd --home /stride/.strided --keyring-backend test --from val1 --chain-id STRIDE_1 -y

docker-compose --ansi never exec -T stride1 strided --home /stride/.strided --keyring-backend test tx ibc-transfer transfer transfer channel-1 cosmos1pcag0cj4ttxg8l7pcg0q4ksuglswuuedcextl2 1000ustrd --from val1 --chain-id STRIDE_1 -y
...
docker-compose run hermes hermes -c /tmp/hermes.toml tx raw chan-open-init GAIA_1 STRIDE_1 connection-0 transfer transfer
