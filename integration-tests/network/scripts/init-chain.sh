...
update_default_genesis() {
    ...
    jq_inplace '.app_state.icqoracle.params.osmosis_chain_id |= "osmosis-1"' $genesis_json
    jq_inplace '.app_state.icqoracle.params.osmosis_connection_id |= "connection-0"' $genesis_json
    jq_inplace '.app_state.icqoracle.params.update_interval_sec |= "60"' $genesis_json
    jq_inplace '.app_state.icqoracle.params.price_expiration_timeout_sec |= "120"' $genesis_json
