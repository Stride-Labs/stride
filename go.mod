module github.com/Stride-Labs/stride/v11
...
replace (
	...
	github.com/cosmos/interchain-security/v3 => github.com/Stride-Labs/interchain-security/v3 v3.0.0-rc2.0.20230630151730-3e5aa52bfe3c
