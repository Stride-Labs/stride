...
replace (
	...
	// Has changes for integration testing infra
	github.com/cosmos/interchain-security/v3 => github.com/Stride-Labs/interchain-security/v3 v3.2.0-ibctesting-infra
