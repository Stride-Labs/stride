...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/Stride-Labs/cosmos-sdk v0.47.15-stride-distribution-fix-0-mempool-verbose-error-1beta
	github.com/cosmos/ibc-go/v7 => github.com/Stride-Labs/ibc-go/v7 v7.4.0--mempool-verbose-error-1beta
	github.com/cosmos/interchain-security/v4 => github.com/Stride-Labs/interchain-security/v4 v4.0.0-mempool-verbose-error-1beta
