...
edit_config () {
    ...
    dasel put string -f $CONFIG_FOLDER/config.toml '.persistent_peers' "{NODE_ID_TWO}@stride2:26658"
    dasel put string -f $CONFIG_FOLDER/config.toml '.p2p.persistent_peers' "{NODE_ID_TWO}@stride2:26658"
}
