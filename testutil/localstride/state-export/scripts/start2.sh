...
edit_config () {
    ...
    dasel put string -f $CONFIG_FOLDER/config.toml '.persistent_peers' "09f45469811c7b7faf618313fef8b9204a8e179f@stride:26656"
    dasel put string -f $CONFIG_FOLDER/config.toml '.p2p.persistent_peers' "09f45469811c7b7faf618313fef8b9204a8e179f@stride:26656"
}
