...
export interface EpochsEpochInfo {
  identifier?: string;
...
export interface EpochsQueryCurrentEpochResponse {
  /** @format int64 */
  current_epoch?: string;
}

export interface EpochsQueryEpochsInfoResponse {
  epochs?: EpochsEpochInfo[];
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/Stridelabs/stride/epochs
   */
  queryEpochInfos = (
    query?: {
   ...
   * @request GET:/Stridelabs/stride/epochs/current_epoch
   */
