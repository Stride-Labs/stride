...
import { MsgRegisterHostZone } from "./types/stakeibc/tx";
...
const types = [
  ...
  ["/Stridelabs.stride.stakeibc.MsgRegisterHostZone", MsgRegisterHostZone],
...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgRegisterHostZone: (data: MsgRegisterHostZone): EncodeObject => ({ typeUrl: "/Stridelabs.stride.stakeibc.MsgRegisterHostZone", value: MsgRegisterHostZone.fromPartial( data ) }),
