...
export type StakeibcMsgSubmitTxResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/Stride-Labs/stride/stakeibc/host_zone/{chain_id}
   */
  queryHostZone = (chain_id: string, params: RequestParams = {}) =>
