...
$HERMES_CMD create connection --a-chain $STRIDE_CHAIN_ID --b-chain $GAIA_CHAIN_ID

echo "Creating transfer channel for Gaia"
$HERMES_CMD create channel --a-chain $GAIA_CHAIN_ID --a-connection connection-0 --a-port transfer --b-port transfer
...
$HERMES_CMD create connection --a-chain $STRIDE_CHAIN_ID --b-chain $OSMO_CHAIN
...
$HERMES_CMD create connection --a-chain $STRIDE_CHAIN_ID --b-chain $JUNO_CHAIN
