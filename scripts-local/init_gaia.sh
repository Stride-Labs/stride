...
$GAIA_CMD_2 gentx $GAIA_VAL_ACCT_2 1000000000000uatom --chain-id $GAIA_CHAIN --output-document=$GAIA_HOME/config/gentx/gval2.json
...
$GAIA_CMD gentx $GAIA_VAL_ACCT 1000000000000uatom --chain-id $GAIA_CHAIN 2> /dev/null
