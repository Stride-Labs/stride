...
make build 
make install
/stride/go/bin/faucet --cli-name strided --denoms ustrd,ibc/27394FB092D2ECCD56123C74F36E4C1F926001CEADA9CA97EA622B25F41E5EB2 --account-name val2 --keyring-backend test --credit-amount 10000000 --max-credit 5000000001 --home /stride/.stride --port 27936
