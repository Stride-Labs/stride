...
make build 
make install
/stride/go/bin/faucet --cli-name strided --denoms ustrd --account-name val2 --keyring-backend test --credit-amount 10000000 --max-credit 30000001 --home /stride/.stride --node https://stride-node2.internal.stridenet.co:26657 --port 7936
