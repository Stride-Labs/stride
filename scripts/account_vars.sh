...
STARS_ADDRESS=$($STARS_MAIN_CMD keys show ${STARS_VAL_PREFIX}1 --keyring-backend test -a)
...
HERMES_STARS_ADDRESS=$($STARS_MAIN_CMD keys show $HERMES_STARS_ACCT --keyring-backend test -a)
