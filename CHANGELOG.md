...
### Changelog
## [v10](https://github.com/Stride-Labs/stride/releases/tag/v10) - 2023-05-25
!!!ACTION ITEM: Move the following to the On-Chain vs Off-chain sections!!!

### On-Chain changes

### Off-Chain changes
These changes do not affect any on-chain functionality, but have been implemented since `v9`
